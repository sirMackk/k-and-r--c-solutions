/* 5-17: Add a field-handling capability, so sorting may be done on fields
...
void lowercase(char *);
void directory(char *);
void extract_field(char *);

int numeric, reverse, fold, dir, field;

int main(int argc, char *argv[])
{
    int nlines;

    numeric = reverse = fold = dir = field = 0;
...
/* Extracts a field from a space-delimited line of characters. */
void extract_field(char *input)
{
    int i, j, k, len;
